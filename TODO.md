...
- [~] **Low-flow pressure tests — STARTED 2026-08-25.** First point in:
      ...
      **y = 60.2 − 0.02794·x²** (y = pump psi, x = heads; CVs closed, no
      ...
      - A running lawn zone subtracts ~1.5-4 psi (schedule since
        2026-08-31: house lawn Sun/Mon/Wed/Fri ~65 min — zones 20/20/15/10;
        pump lawn Sat/Tue/Thu ~30 min — 15/15; both at 07:00 and 19:00);
        any CV opening pulls lower still — that's the PID's term, not the
        equation's.
...
- C-field line swap = ~19-22 psi for 1.5-2 min while the big line fills
  ...
  Lawn schedule since 2026-08-31: house lawn Sun/Mon/Wed/Fri (~65 min,
  zones 20/20/15/10), pump lawn Sat/Tue/Thu (~30 min, 15/15) — one
  controller per day, 07:00 and 19:00 (pump lawn was daily 06:00 before).
